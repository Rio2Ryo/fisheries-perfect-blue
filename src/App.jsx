...
function App() {
  ...
  const handleTabChange = (tabId) => {
    ...
    setMobileMenuOpen(false) // モバイルメニューも閉じる
  }
                ...
                <div className="bg-white rounded-lg shadow-md p-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-start space-x-2">
                      <span className="text-blue-600 font-medium text-sm">MVファクトリー:</span>
                      <span className="text-green-600 text-sm">◯約30倍の速度で成長</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <span className="text-gray-600 font-medium text-sm">従来の藻養殖:</span>
                      <span className="text-red-600 text-sm">✕遅い（週〜月）</span>
                    </div>
                  </div>
                </div>
                
                <div className="bg-white rounded-lg shadow-md p-4">
                  <h4 className="font-bold text-gray-900 mb-3">育成環境</h4>
                  <div className="space-y-2">
                    <div className="flex items-start space-x-2">
                      <span className="text-blue-600 font-medium text-sm">MVファクトリー:</span>
                      <span className="text-green-600 text-sm">◯完全閉鎖型・人工光制御</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <span className="text-gray-600 font-medium text-sm">従来の藻養殖:</span>
                      <span className="text-red-600 text-sm">✕開放型・天候依存</span>
                    </div>
                  </div>
                </div>
                
                <div className="bg-white rounded-lg shadow-md p-4">
                  <h4 className="font-bold text-gray-900 mb-3">取り扱い種類</h4>
                  <div className="space-y-2">
                    <div className="flex items-start space-x-2">
                      <span className="text-blue-600 font-medium text-sm">MVファクトリー:</span>
                      <span className="text-green-600 text-sm">◯2,000種類</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <span className="text-gray-600 font-medium text-sm">従来の藻養殖:</span>
                      <span className="text-red-600 text-sm">✕数種類〜数十種類</span>
                    </div>
                  </div>
                </div>
                
                <div className="bg-white rounded-lg shadow-md p-4">
                  <h4 className="font-bold text-gray-900 mb-3">展開可能エリア</h4>
                  <div className="space-y-2">
                    <div className="flex items-start space-x-2">
                      <span className="text-blue-600 font-medium text-sm">MVファクトリー:</span>
                      <span className="text-green-600 text-sm">◯都市・山間・僻地・被災地も可</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <span className="text-gray-600 font-medium text-sm">従来の藻養殖:</span>
                      <span className="text-red-600 text-sm">✕限定（温暖地域中心）</span>
                    </div>
                  </div>
                </div>
              </div>
